...
import portfolio1 from "@/assets/shoppe/1.png";
import portfolio2 from "@/assets/shoppe/2.png";
import portfolio3 from "@/assets/shoppe/3.png";
import portofolio4 from "@/assets/shoppe/4.png";
import portofolio5 from "@/assets/shoppe/5.png";
    ...
    <section id="porto" className="py-20 bg-gradient-to-b from-background to-secondary/20">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                          <div className="absolute bottom-4 left-4 right-4">
                            <Button 
                              ...
                              onClick={() => { setShowModal(true); setCurrentIndex(index); }}
                            >
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl shadow-xl max-w-4xl w-full relative p-6">
            {/* Tombol Close */}
            <button
            ...
            <Button
              variant="outline"
              size="icon"
              className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-white/80 border hover:bg-white"
              onClick={prevSlide}
            >
              <ChevronLeft className="h-5 w-5" />
            </Button>
            <Button
              variant="outline"
              size="icon"
              className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-white/80 border hover:bg-white"
              onClick={nextSlide}
            >
              <ChevronRight className="h-5 w-5" />
            </Button>
